...
<section class="poc-col-sm-12 poc-col-md-8 poc-col-l-10">
    ...
    <div class="poc-row">
        <div class="poc-content">
            ...
            <h1>Forms</h1>
            <!--    Search button searches in google.com, if you want you can change it  into your domain name to search in yourwebsite only -->
...
&lt;div&gt;
            ...
            <p>This is used to create a dropdown list. The select element is used to create a dropdown list, the option tag is used inside select element to define the options list.</p>
            <div class="poc-form-item">
                <label>Month</label>
                <select>
